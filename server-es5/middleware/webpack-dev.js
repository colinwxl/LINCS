...
exports.default = function (compiler, publicPath) {
  ...
  var middleware = (0, _webpackDevMiddleware2.default)(compiler, {
    ...
    contentBase: paths.base(_config2.default.dirClient),
    hot: true,
    quiet: _config2.default.compilerQuiet,
    noInfo: _config2.default.compilerQuiet,
    lazy: false,
    stats: _config2.default.compilerStats
  });
