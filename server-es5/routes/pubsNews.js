      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            }).fetchAll({ withRelated: ['authors', { authors: function authors(query) {
                  query.orderBy('author_rank');
                } }] });
...
function generateRIS(pub) {
  return new _promise2.default(function (resolve) {
    var firstAuthorLastName = getFirstAuthorName(pub);
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _Publication.Publication.where('id', ctx.params.id).fetch({
              withRelated: ['authors', { authors: function authors(query) {
                  query.orderBy('author_rank');
                } }]
            });
