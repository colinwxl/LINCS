...
export default {
  ...
  tools: {
    ...
    transcript: { type: 'integer', nullable: false, defaultTo: false },
    protein: { type: 'integer', nullable: false, defaultTo: false },
    cell_state: { type: 'integer', nullable: false, defaultTo: false },
    morphology: { type: 'integer', nullable: false, defaultTo: false },
    drug_binding: { type: 'integer', nullable: false, defaultTo: false },
    formatting: { type: 'integer', nullable: false, defaultTo: false },
    storage: { type: 'integer', nullable: false, defaultTo: false },
    visualization: { type: 'integer', nullable: false, defaultTo: false },
    analysis: { type: 'integer', nullable: false, defaultTo: false },
