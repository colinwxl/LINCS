...
export default {
  ...
  tools: {
    ...
    transcriptomics: { type: 'integer', nullable: false, defaultTo: false },
    proteomics: { type: 'integer', nullable: false, defaultTo: false },
    epigenomics: { type: 'integer', nullable: false, defaultTo: false },
    imaging: { type: 'integer', nullable: false, defaultTo: false },
    viability: { type: 'integer', nullable: false, defaultTo: false },
    ...
    enrichment: { type: 'integer', nullable: false, defaultTo: false },
    networks: { type: 'integer', nullable: false, defaultTo: false },
    search_engine: { type: 'integer', nullable: false, defaultTo: false },
    data_viz: { type: 'integer', nullable: false, defaultTo: false },
