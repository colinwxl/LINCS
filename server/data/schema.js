...
export default {
  ...
  tools: {
    ...
    transcriptomics: { type: 'integer', nullable: false },
    proteomics: { type: 'integer', nullable: false },
    epigenomics: { type: 'integer', nullable: false },
    imaging: { type: 'integer', nullable: false },
    viability: { type: 'integer', nullable: false },
    integration: { type: 'integer', nullable: false },
    web_based: { type: 'integer', nullable: false },
    api: { type: 'integer', nullable: false },
    enrichment: { type: 'integer', nullable: false },
    networks: { type: 'integer', nullable: false },
    search_engine: { type: 'integer', nullable: false },
    data_viz: { type: 'integer', nullable: false },
    ontology: { type: 'integer', nullable: false },
    database: { type: 'integer', nullable: false },
  },
  tools_publications: {
    id: { type: 'increments', nullable: false, primary: true },
