...
export default class Workflow extends Component {
  ...
  static subTitle = 'Find novel compounds that mimic or reverse a disease signature'
  static path = 'find-novel-compounds-that-mimic-or-reverse-a-disease-signature'
          ...
          <div className="row">
            ...
            <div className={`col-md-9 col-md-pull-3 ${styles.workflow} ${styles.mimic}`}>
              ...
              <p>
                ...
                (<a href="http://amp.pharm.mssm.edu/L1000CDS2" target="_blank">http://amp.pharm.mssm.edu/L1000CDS<sup>2</sup></a>). The
