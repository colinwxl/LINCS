...
import DSSCincinatti2017 from 'static/files/SBDSS.jpg';
                    ...
                    <div className={styles['carousel-pad']}>
                      <Carousel autoplay infinite aps={8000}>
                        ...
                        <div className={styles['carousel-item-wrap']}>
                          ...
                          <p className={styles.meeting}>
                            Members of LINCS DSGCs will be presenting at
                            AACR Annual Meeting 2017 to highlight potential opportunities
                            in cancer therapy research using data generated by the LINCS
                            Program. This event will be held on&nbsp;
                            <strong>April 1-5, 2017</strong> in Washington, D.C.&nbsp;
                            <a
                              href="https://sites.google.com/view/sbdss2017"
                              target="_blank"
                            >Learn More</a>
