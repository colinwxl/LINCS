...
export default function LINCSPCCSE() {
  return (
    <div className={styles.wrapper}>
      <PageBanner
        title="LINCS PCCSE"
        subTitle={
          'The LINCS Proteomic Characterization Center for Signaling ' +
        ...
        imgSrc="/LINCS/files/centers_logos/lincs-pccse.png"
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-9 col-md-pull-3">
            <ul>
              <li>
                Project Title: <a href="http://projectreporter.nih.gov/project_description.cfm?projectnumber=1U54HG008097-01" target="_blank">
                There and Back Again: Epigenetic Reinforcement of Cellular Signaling
                States (1U54HG008097)</a>
              </li>
              <li>
                Principal Investigator: <a href="http://www.broadinstitute.org/~jjaffe/" target="_blank">
                Jake Jaffe PhD</a>
              </li>
              <li>
              ...
              <li>
                Related Website: <a href="https://panoramaweb.org/labkey/project/LINCS/begin.view" target="_blank">
                LINCS PCCSE Panorama Repository</a>
              </li>
            </ul>
            <h2>Overview</h2>
            <p>
