...
export default function DSGCs() {
  return (
    <div className={styles.wrapper}>
      <PageBanner
        title="LINCS Data and Signature Generation Centers (DSGCs)"
        subTitle={
          'The DSGCs profile the response of human cells ' +
          'to many exogenous and endogenous perturbations'
        }
      />
            ...
            <div className={`${styles.content} dsgcs`}>
              ...
              <div className="entry">
                <p className={styles.intro}>
                  ...
                  behalf of
                  the <a title="NIH Common Fund" href="https://commonfund.nih.gov/" target="_blank">
                  NIH Common Fund</a>.
                </p>
                ...
                <div className={styles['center-info']}>
                  ...
                  <p>
                    ...
                    how cells perpetuate non-genetic information as they
                    grow. <Link title="LINCS PCCSE" to={`${dsgcRoute}/lincs-pccse`}>
                    Learn More</Link>
                  </p>
                </div>
                <div className={styles['center-info']}>
                  ...
                  <p>
                    ...
                    expression readouts in cell
                    lines. <Link title="MEP LINCS Center" to={`${dsgcRoute}/mep-lincs`}>
                    Learn More</Link>
                  </p>
                </div>
                <div className={styles['center-info']}>
                  ...
                  <p>
                    ...
                    also known as Lou Gehrig’s disease), spinal muscular atrophy and Huntington’s
                    disease. <Link title="NeuroLINCS Center" to={`${dsgcRoute}/neurolincs`}>
                    Learn More</Link>
                  </p>
                </div>
                <p>
