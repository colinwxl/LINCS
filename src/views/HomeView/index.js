      ...
      <div className={styles.wrapper}>
        ...
        <div className={`${styles.content}`}>
          <div className="container">
            <div className="row">
              <div
                className={`col-xs-12 col-md-8 ${styles.section} ${styles['recent-ds-section']}`}
              >
              ...
              <div className={`col-xs-12 col-md-4 ${styles.section} ${styles['tools-section']}`}>
                <h4>Recent LINCS Tools</h4>
                {tools && tools.map(tool => <Tool tool={tool} />)}
              </div>
            </div>
          </div>
