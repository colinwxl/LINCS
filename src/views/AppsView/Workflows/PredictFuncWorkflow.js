  ...
  return (
    <div className={styles.wrapper}>
      <PageBanner
        ...
        subTitle="Finding attributes about genes and proteins for machine learning"
      />
      <div className="container">
        <div className="row">
          <div className={`col-xl-9 ${styles.workflow} ${styles['predict-func']}`}>
            <h3>DCIC processed datasets ready for machine learning</h3>
            <p>
            ...
            <ol>
              ...
              <li>
                ...
                this: <a href="http://amp.pharm.mssm.edu/Harmonizome/search?q=breast%20cancer&t=geneSet" target="_blank">
            ...
            <ol>
              <li>
                ...
                set: <a href="http://amp.pharm.mssm.edu/Harmonizome/gene_set/breast+cancer/DISEASES+Curated+Gene-Disease+Assocation+Evidence+Scores" target="_blank">
              ...
              <li>
                ...
                case: <a href="http://amp.pharm.mssm.edu/Harmonizome/dataset/DISEASES+Curated+Gene-Disease+Assocation+Evidence+Scores" target="_blank">
              ...
              <li>
                ...
                example: <a href="http://amp.pharm.mssm.edu/static/hdfs/harmonizome/data/jensendiseasecurated/gene_attribute_matrix.txt.gz" target="_blank">
