  ...
  return (
    <div className={styles.wrapper}>
      <PageBanner
        ...
        subTitle="Explore microscopy imaging data collected across the LINCS centers"
      />
      <div className="container">
        <div className="row">
          <div className={`col-xl-9 ${styles.workflow} ${styles['sm-mechanism-workflow']}`}>
            <p>
              <strong>Three LINCS data generation centers: HMS-LINCS, MEP-LINCS, and NeuroLINCS
              collect microscopy imaging data:</strong>
            </p>
