...
export default class HMSLINCS extends Component {
  render() {
    return (
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-9 col-md-pull-3">
              <ul>
                <li>
                  Project Title: <a href="http://projectreporter.nih.gov/project_description.cfm?projectnumber=1U54HL127365-01" target="_blank">Pharmaco-Response Signatures and Disease Mechanisms (1U54HL127365)</a>
                </li>
                <li>
                  Principal Investigator: <a href="http://sorger.med.harvard.edu/people/peter-sorger-phd/" target="_blank">Peter Sorger PhD</a>
                </li>
                <li>
                  Awardee Institution: <a title="Harvard Medical School" href="http://hms.harvard.edu/" target="_blank">Harvard Medical School</a>
                </li>
                <li>
                  Center Website: <a href="http://lincs.hms.harvard.edu/">HMS LINCS Center</a>
                </li>
              </ul>
              <h2>Goals</h2>
              <p>
              ...
              <p>
                ...
                the <a title="BD2K-LINCS Data Coordination and Integration Center" href="http://www.lincsproject.org/centers/bd2k-lincs-dcic/">BD2K-LINCS Data Coordination and Integration Center</a>,
                and grounded in established ontologies and standards, will make it possible to
                access <a title="HMS LINCS Data" href="http://lincs.hms.harvard.edu/db/" target="_blank">HMS LINCS data</a> and
