...
export default class MEPLINCS extends Component {
  render() {
    return (
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-9 col-md-pull-3">
              <ul>
                <li>
                  Project Title: <a href="http://projectreporter.nih.gov/project_description.cfm?projectnumber=1U54HG008100-01" target="_blank">Extrinsic Perturbations of Cell Physiology and Associated Regulatory Networks (1U54HG008100)</a>
                </li>
                <li>
                  Principal Investigators: <a href="http://www.ohsu.edu/xd/education/schools/school-of-medicine/departments/basic-science-departments/biomedical-engineering/people/joe-gray.cfm" target="_blank">Joe Gray PhD</a>, <a href="http://www.ohsu.edu/xd/education/schools/school-of-medicine/departments/basic-science-departments/biomedical-engineering/people/laura-heiser.cfm" target="_blank">Laura Heiser PhD</a>, <a href="http://www.ohsu.edu/xd/education/schools/school-of-medicine/departments/basic-science-departments/biomedical-engineering/people/james-korkola.cfm" target="_blank">James Korkola PhD</a>
                </li>
                <li>
              ...
              <h2>Resources</h2>
                <ul>
                  ...
                  <li>
                    <a href="http://www.ohsu.edu/xd/education/schools/school-of-medicine/departments/basic-science-departments/biomedical-engineering/spatial-systems-biomedicine/">
