...
export default class NeuroLINCS extends Component {
  render() {
    return (
      <div className={styles.wrapper}>
        <PageBanner
          title="NeuroLINCS"
          subTitle="The NeuroLINCS Center at the University of California-Irvine."
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-9 col-md-pull-3">
              <ul>
                <li>
                  Project Title: <a href="http://projectreporter.nih.gov/project_description.cfm?projectnumber=1U54NS091046-01" target="_blank">Neuron and Glial Cellular Signatures from Normal and Diseased iPS Cells (1U54NS091046)</a>
                </li>
                <li>
                  Principal Investigators: <a href="http://www.faculty.uci.edu/profile.cfm?faculty_id=4708" target="_blank">Leslie Thompson PhD</a>, <a href="http://gladstoneinstitutes.org/scientist/finkbeiner" target="_blank">Steven Finkbeiner MD/PhD</a>, <a href="https://be.mit.edu/directory/ernest-fraenkel" target="_blank">Ernest Fraenkel PhD</a>, <a href="http://neuroscience.jhu.edu/resources/directory/faculty/Jeffrey-Rothstein" target="_blank">Jeffrey Rothstein MD/PhD</a>, <a href="https://www.cedars-sinai.edu/Research/Faculty-Directory/Bios/Clive-Svendsen-PhD.aspx" target="_blank">Clive Svendsen PhD</a>
                </li>
                <li>
                  Awardee Institution: <a title="University of California, Irvine" href="http://uci.edu/" target="_blank">University of California-Irvine</a>
                </li>
                <li>
                  Press Release: <a title="UCI to lead $8 million effort to create library of brain cell activity" href="http://news.uci.edu/press-releases/uci-to-lead-8-million-effort-to-create-library-of-brain-cell-activity/" target="_blank">UCI to lead $8 million effort to create library of brain cell activity</a>
                </li>
                <li>
              ...
              <p>
                ...
                to interact with other LINCS sites, and to prepare for the <Link to="/centers/bd2k-lincs-dcic/">DCIC</Link> and
                the prospect of disseminating knowledge and resources at scale.
              </p>
            </div>
          </div>
        </div>
