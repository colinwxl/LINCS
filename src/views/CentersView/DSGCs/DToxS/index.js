  ...
  render() {
    return (
      <div className={`${styles.wrapper} ${styles.dtoxs}`}>
        <PageBanner
          title="DToxS"
          subTitle="The Drug Toxicity Signature Generation Center located at the Icahn School of Medicine at Mount Sinai in New York City."
          imgSrc={require('./DToxS.png')}
          imgAlt="DToxS Logo"
        />
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-9 col-md-pull-3">
              <ul>
                <li>
                  Project Title: <a href="http://projectreporter.nih.gov/project_description.cfm?projectnumber=1U54HG008098-01" target="_blank">Drug Combination Signatures for Prediction and Mitigation of Toxicity (1U54HG008098)</a>
                </li>
                <li>
                  Principal Investigators: <a href="http://icahn.mssm.edu/profiles/srinivas-ravi-iyengar" target="_blank">Ravi Iyengar PhD</a>, <a href="http://icahn.mssm.edu/profiles/marc-birtwistle" target="_blank">Marc Birtwistle PhD</a>, <a href="http://icahn.mssm.edu/profiles/eric-a-sobie" target="_blank">Eric Sobie PhD</a>
                </li>
                <li>
                  Awardee Institution: <a title="Icahn School of Medicine at Mount Sinai" href="http://icahn.mssm.edu/" target="_blank">Icahn School of Medicine at Mount Sinai</a>
                </li>
                <li>
                  Press Release: <a title="Center to Find Drug Combinations that Reduce Side Effects" href="http://www.newswise.com/articles/center-to-find-drug-combinations-that-reduce-side-effects" target="_blank">Center to Find Drug Combinations that Reduce Side Effects</a>
                </li>
                <li>
              ...
              <ol>
                ...
                <li>
                  ...
                  cellular phenotypes inferred by the <a href="http://www.lincsproject.org/centers/data-and-signature-generating-centers/oregon-u/" target="_blank">MEP</a> and <a title="HMS LINCS Center" href="http://www.lincsproject.org/centers/data-and-signature-generating-centers/hms-lincs-u54/">HMS</a> LINCS Centers. This integrative approach generate sets of experimentally-observed (EOS), network-inferred (NIS) and dynamical model weighted (wEOS &amp; wNIS) signatures for both drug combinations and individual drugs at signatures per year from our Center’s experiments.
                </li>
                <li>
                  We will extensively share our data and resources. We will provide the raw and
                  processed data with annotations to the <a title="BD2K-LINCS Data Coordination and Integration Center" href="http://www.lincsproject.org/centers/bd2k-lincs-dcic/">BD2K-LINCS Data Coordination and Integration Center</a> for dissemination to the larger community. We will provide our hiPSC-derived cardiomyocytes, hepatocytes and neurons to all other <a title="LINCS Data and Signature Generation Centers" href="http://www.lincsproject.org/centers/data-and-signature-generating-centers/">LINCS centers</a> for use in their assay systems and to the biomedical research community. We will develop computational models that integrate our toxicity data with those from other LINCS centers to develop molecular signature based efficacy to toxicity ratios that could be broadly useful in drug development. We will run web-based courses using Coursera for data utilization and development of signature–based research projects and conduct personalized workshops online to enable academic researchers to utilize our signatures to develop research projects that can compete for individual research grant funding.
                </li>
              </ol>
            </div>
          </div>
