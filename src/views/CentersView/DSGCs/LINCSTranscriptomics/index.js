...
export default class LINCSTranscriptomics extends Component {
  render() {
    return (
      <div className={styles.wrapper}>
        <PageBanner
          title="LINCS Transcriptomics"
          subTitle="The LINCS Center for Transcriptomics at the Broad Institute in Cambridge, MA."
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-9 col-md-pull-3">
              <ul>
                <li>
                  Project Title: <a href="http://projectreporter.nih.gov/project_description.cfm?projectnumber=1U54HL127366-01" target="_blank">Broad Institute LINCS Center for Transcriptomics (1U54HL127366)</a>
                </li>
                <li>
                  Principal Investigators: <a href="https://www.broadinstitute.org/what-broad/history-leadership/scientific-leadership/core-members/todd-r-golub" target="_blank">Todd Golub MD</a>, Aravind Subramanian PhD
                </li>
                <li>
